...
class EntertainmentNewsFragment : Fragment(R.layout.fragment_entertainment_news) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        newsAdapter.setOnItemClickListener {
            ...
            findNavController().navigate(
                R.id.action_entertainmentNewsFragment_to_articleFragment,
                bundle
            )
        }
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            if(shouldPaginate) {
                ...
                rvEntertainmentNews.setPadding(0, 0, 0, 0)
            }
        }
    ...
    private fun setupRecyclerView() {
        ...
        rvEntertainmentNews.apply {
            ...
            addOnScrollListener(this@EntertainmentNewsFragment.scrollListener)
        }
    }
}
