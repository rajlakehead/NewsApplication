...
class SportNewsFragment : Fragment(R.layout.fragment_sport_news) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        newsAdapter.setOnItemClickListener {
            ...
            findNavController().navigate(
                R.id.action_sportNewsFragment_to_articleFragment,
                bundle
            )
        }
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            if(shouldPaginate) {
                viewModel.getSportNews("us")
                isScrolling = false
            } else {
                rvSportNews.setPadding(0, 0, 0, 0)
            }
        }
    ...
    private fun setupRecyclerView() {
        ...
        rvSportNews.apply {
            ...
            addOnScrollListener(this@SportNewsFragment.scrollListener)
        }
    }
}